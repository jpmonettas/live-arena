(defproject live-arena "0.1.0-SNAPSHOT"
  ...
  :ring {:handler live-arena.handler/app
         :uberwar-name "live-arena.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "live-arena.jar"
  ...
  :profiles {:uberjar {:hooks [leiningen.cljsbuild minify-assets.plugin/hooks]
                       :env {:production true}
                       :aot :all
                       :omit-source true
                       :cljsbuild {:jar true
                                   :builds {:app
                                             {:source-paths ["env/prod/cljs"]
                                              ...
                                              {:optimizations :advanced
                                               :pretty-print false}}}}}
             :dev {:repl-options {:init-ns live-arena.handler
